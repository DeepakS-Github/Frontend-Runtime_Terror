...
function CropPredictor() {
  ...
  const handleSubmit = async (e) => {
    ...
    let userQues = `region: ${region}, soil: ${soil}, temperature: ${temperature} degree celcius, altitude: ${altitude} km, humidity: ${humidity}%, rainfall: ${rainfall} mm. Recommed me the crops that can be grown in India following the given conditions. Write only one crop name.`;
