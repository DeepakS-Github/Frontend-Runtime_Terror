...
function FarmerDashboard() {
  ...
  const handleEdit = (toEdit) => {
    ...
    fetch(
      `${apiUrl}/api/farmerdashboard/getItemData/update/${toEdit}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
  ...
  const handleDelete = (toDelete) => {
    ...
    fetch(
      `${apiUrl}/api/farmerdashboard/getItemData/delete/${toDelete}`,
      {
        method: "DELETE",
      }
    )
  ...
  let API = `${apiUrl}/api/farmerdashboard/getItemData/${farmerID}`;
