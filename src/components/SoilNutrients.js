...
function CropGrowingSteps() {
  ...
  const handleSubmit = async (e) => {
    ...
    let userQues = `If I want to grow ${crops} then what are the parameters of the soil I need write their units also. Give answers in points and don't give any of your review.`;
